...
//   // Tìm tất cả các thẻ <small> hoặc thẻ chứa lỗi (bạn nên gán class error-message cho chúng)
...
function validateProduct(data, isEdit = false) {
  ...
  // Hàm hỗ trợ hiển thị lỗi an toàn
...
// Đừng quên cập nhật hàm clearErrors để xóa định dạng cũ
function clearErrors() {
